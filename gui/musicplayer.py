...
class Player(wx.Frame):
    ...
    def OnOpen(self, evt):
        ...
        dlg = wx.FileDialog(self, "Choose a file", user.home, "","*.*", wx.FD_OPEN)
        if dlg.ShowModal() == wx.ID_OK:
            ...
            self.Media = self.Instance.media_new("http://dl.taksedaclub.ir/download/1393/10/Taylor%20Swift%20-%20Blank%20Space%20(Gibs%20Ft.%20Noize%20Remix%202015)%20[320].mp3")
            ...
            if title == -1:
                title = filename
            self.SetTitle("%s - Music Player" % title)
